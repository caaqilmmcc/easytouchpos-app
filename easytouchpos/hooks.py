app_name = "easytouchpos"
app_title = "easytouchpos"
...
doctype_js = {
    "POS Profile": "easytouchpos/api/pos_profile.js",
    "Sales Invoice": "easytouchpos/api/invoice.js",
    "Company": "easytouchpos/api/company.js",
}

after_uninstall = "easytouchpos.uninstall.after_uninstall"


doc_events = {
    "Sales Invoice": {
        "validate": "easytouchpos.easytouchpos.api.invoice.validate",
        "before_submit": "easytouchpos.easytouchpos.api.invoice.before_submit",
        "before_cancel": "easytouchpos.easytouchpos.api.invoice.before_cancel",
    },
    "Customer": {
        "validate": "easytouchpos.easytouchpos.api.customer.validate",
        "after_insert": "easytouchpos.easytouchpos.api.customer.after_insert",
    },
} 
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "POS Profile-posa_pos_easytouch_settings",
                    ...
                    "POS Profile-posa_pos_easytouch_advance_settings",
                    ...
                    "POS Profile-pos_easytouch_payments",
                    "POS Profile-posa_use_pos_easytouch_payments",
...
# app_include_css = "/assets/easytouchpos/css/easytouchpos.css"
# app_include_js = "/assets/easytouchpos/js/easytouchpos.js"

# include js, css files in header of web template
# web_include_css = "/assets/easytouchpos/css/easytouchpos.css"
# web_include_js = "/assets/easytouchpos/js/easytouchpos.js"

# include custom scss in every website theme (without file extension ".scss")
# website_theme_scss = "easytouchpos/public/scss/website"
...
# app_include_icons = "easytouchpos/public/icons.svg"
...
# jinja = {
# 	"methods": "easytouchpos.utils.jinja_methods",
# 	"filters": "easytouchpos.utils.jinja_filters"
# }

# Installation
# ------------

# before_install = "easytouchpos.install.before_install"
# after_install = "easytouchpos.install.after_install"

# Uninstallation
# ------------

# before_uninstall = "easytouchpos.uninstall.before_uninstall"
# after_uninstall = "easytouchpos.uninstall.after_uninstall"
...
# before_app_install = "easytouchpos.utils.before_app_install"
# after_app_install = "easytouchpos.utils.after_app_install"
...
# before_app_uninstall = "easytouchpos.utils.before_app_uninstall"
# after_app_uninstall = "easytouchpos.utils.after_app_uninstall"

# Desk Notifications
# ------------------
# See frappe.core.notifications.get_notification_config

# notification_config = "easytouchpos.notifications.get_notification_config"
...
# scheduler_events = {
# 	"all": [
# 		"easytouchpos.tasks.all"
# 	],
# 	"daily": [
# 		"easytouchpos.tasks.daily"
# 	],
# 	"hourly": [
# 		"easytouchpos.tasks.hourly"
# 	],
# 	"weekly": [
# 		"easytouchpos.tasks.weekly"
# 	],
# 	"monthly": [
# 		"easytouchpos.tasks.monthly"
# 	],
# }
...
# before_tests = "easytouchpos.install.before_tests"

# Overriding Methods
# ------------------------------
#
# override_whitelisted_methods = {
# 	"frappe.desk.doctype.event.event.get_events": "easytouchpos.event.get_events"
# }
#
...
# 	"Task": "easytouchpos.task.get_dashboard_data"
# }
...
# Request Events
# ----------------
# before_request = ["easytouchpos.utils.before_request"]
# after_request = ["easytouchpos.utils.after_request"]

# Job Events
# ----------
# before_job = ["easytouchpos.utils.before_job"]
# after_job = ["easytouchpos.utils.after_job"]
