...
from easytouchpos.easytouchpos.api.m_pesa import submit_mpesa_payment
...
def process_pos_payment(payload):
    ...
    if not data.pos_profile.get("posa_use_pos_easytouch_payments"):
        frappe.throw(_("POS easytouch Payments is not enabled for this POS Profile"))
